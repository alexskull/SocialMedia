...
$this->active = substr_replace($this->active, "1", -6, 1);
$this->routing = array(Label::eventos, Label::mis_eventos);
$this->section_title = Label::mis_eventos;
$content = function(){ ?>
        ...
        <table class = "table table-bordered table-striped responsive">
            <thead>
                <tr>
                    ...
                    <th style = "width: 10%"><?= Label::monto ?></th>
            ...
            <tbody>
                <tr>
                    ...
                    <td></td>                    
                    <td>
                        <?= Tables::button("file-pdf-o", "alizarin", null, "factura", Label::factura) ?>
                    </td>
                </tr>
            </tbody>
        </table>
